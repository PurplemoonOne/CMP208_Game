...
GameState::GameState(gef::Platform& platform, gef::Renderer3D& renderer_, gef::SpriteRenderer& sprite_renderer)
	:
	renderer_3d_(&renderer_),
	...
	platform_(&platform)
{
	...
	button = UIButton::Create(&platform, std::string("BUTT"), gef::Vector2(200.0f, 200.0f));
}
...
void GameState::Update(float delta_time)
{
		...
		input->ControlCamera(camera, delta_time);
...
void GameState::Render()
{
	...
	button->Render(sprite_renderer_);
	DrawHUD();
